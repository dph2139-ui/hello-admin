...
const TABLE_NAME = 'caption_examples'; // e.g., 'llm_models', 'allowed_signup_domains'
const COLUMN_NAME = 'caption';                    // e.g., 'model_name', 'domain'
const PAGE_TITLE = 'Caption Examples';
// ----------------------------------------
