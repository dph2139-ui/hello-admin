...
const TABLE_NAME = 'whitelist_email_addresses'; // e.g., 'llm_models', 'allowed_signup_domains'
const COLUMN_NAME = 'email_address';                    // e.g., 'model_name', 'domain'
const PAGE_TITLE = 'Email Whitelist';
// ----------------------------------------
